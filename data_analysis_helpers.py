...
def ProcessI2(parameterStats,dictSet,frameNumber,file_path):
    ...
    dfBool_1=(dfMinArea) & (parameterStats[dictSet['ya1 ch'][0],0,0:frameNumber,1]<=maxSignal_1) & (parameterStats[dictSet['ya1 ch'][0],0,0:frameNumber,1]>=minSignal_1)
    dfBool_2=(dfMinArea) & (parameterStats[dictSet['ya2 ch'][0],0,0:frameNumber,1]<=maxSignal_2) & (parameterStats[dictSet['ya2 ch'][0],0,0:frameNumber,1]>=minSignal_2)
    ...
    chart1.add_series({
        ...
        'categories': ["Fit", 1, 2, 1+numEntries_1-1, 2],
        'values': ["Fit", 1, 3, 1+numEntries_1-1, 3],
        'trendline': {
            'type': 'linear',
    ...
    chart2.add_series({
        ...
        'categories': ["Fit", 1, 6, 1+numEntries_2-1, 6],
        'values': ["Fit", 1, 7, 1+numEntries_2-1, 7],
        'trendline': {
            'type': 'linear',
            'display_equation': True,
            'line': {
