...
cv2.putText(ReferenceImage, circleText, (borderMargin*3,paperHeight-borderMargin-swatchMargin), font, .75,(0,0,0),1,cv2.LINE_AA)
...
cv2.putText(ReferenceImage, barText, (x-swatchMargin-refSwatchDimension,y+refBarHeight+swatchMargin), font, .5,(0,0,0),1,cv2.LINE_AA)

refBarHeight=paperHeight-borderMargin-swatchMargin*4
refBarLength=refSwatchDimension
hueRange=np.linspace(0,180,refBarHeight)
satRange=np.linspace(10,255,refBarLength)
valRange=255
...
cv2.putText(ReferenceImage, barText, (x+int(refBarLength/2.5),y+refBarHeight+swatchMargin), font, .5,(0,0,0),1,cv2.LINE_AA)
