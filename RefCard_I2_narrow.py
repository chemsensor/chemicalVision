...
#left card
cv2.rectangle(ReferenceImage, (70,30), (280,1200), (255,255,0), -1) #left side of rectangle
cv2.rectangle(ReferenceImage, (70, 990), (830,1200), (255,255,0), -1) #bottom rectangle in digital view
cv2.rectangle(ReferenceImage, (620,30), (830,1200), (255,255,0), -1) #right side of rectangle

#duplicate right card
cv2.rectangle(ReferenceImage, (70 + 900, 30), (280 + 900,1200), (255,255,0), -1) #left side of rectangle
cv2.rectangle(ReferenceImage, (70 + 900, 990), (830 + 900,1200), (255,255,0), -1) #bottom rectangle in digital view
cv2.rectangle(ReferenceImage, (620 + 900, 30), (830 + 900,1200), (255,255,0), -1) #right side of rectangle
...
cv2.circle(ReferenceImage,(725,1095), circler, (255,0,255), -1) 
cv2.circle(ReferenceImage,(725,220), circler, (255,0,255), -1) 

#yellowCircles of left card
cv2.circle(ReferenceImage,(175,220), circler, (0,255,255), -1) 
cv2.circle(ReferenceImage,(175,1095), circler, (0,255,255), -1) 

#magentaCircles of right card
cv2.circle(ReferenceImage,(725 + 900,1095), circler, (255,0,255), -1) 
cv2.circle(ReferenceImage,(725 + 900,220), circler, (255,0,255), -1) 

#yellowCircles of right card
cv2.circle(ReferenceImage,(175 + 900,220), circler, (0,255,255), -1) 
cv2.circle(ReferenceImage,(175 + 900,1095), circler, (0,255,255), -1) 
